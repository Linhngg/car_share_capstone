...
@section('assets')
    ...
    <link href="{{ asset('css/retire-admin.css') }}" rel="stylesheet">
            ...
            <main class="col-md-10 float-left">
                ...
                <table class="table table-hover rounded table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="border-right-0 border-left-0">Date added</th>
                        <th scope="col" class="border-right-0 border-left-0">Retire</th>
                    </tr>
                    </thead>
