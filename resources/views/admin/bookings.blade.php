        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            ...
            <div id="sidebar" class="col-md-2 float-left pl-0 pr-0 collapse width show rounded nav" >
                <div class="list-group border-0 card text-md-left" id="listgroup-span">
                    ...
                    <a href="{{ route('dashboard') }}" class="nav-item border-0 list-group-item d-inline-block collapsed text-light font-weight-bold"><i class="fas fa-home fa-lg img-fluid"></i> <span class="text-left">Cars Table</span></a>
            ...
            <main class="col-md-10 float-left">
                ...
                <table class="table table-hover rounded table-bordered ">
                    <thead class="thead">
                    <tr>
                        <th scope="col" class="border-right-0 border-left-0">#Booking ID</th>
                        <th scope="col" class="border-right-0 border-left-0">Name</th>
                        <th scope="col" class="border-right-0 border-left-0">Email</th>
                        <th scope="col" class="border-right-0 border-left-0">Car</th>
                        <th scope="col" class="border-right-0 border-left-0">Booking Start Date - Time</th>
                        <th scope="col" class="border-right-0 border-left-0">Return Date - Time</th>
                    </tr>
                    </thead>
