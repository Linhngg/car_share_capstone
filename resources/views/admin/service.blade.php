...
@section('assets')
    <link href="{{ asset('css/service-admin.css') }}" rel="stylesheet">
        ...
        <div class="row d-flex d-md-block flex-nowrap wrapper">
            ...
            <div id="sidebar" class="col-md-2 float-left pl-0 pr-0 collapse width show rounded nav" >
                <div class="list-group border-0 card text-md-left" id="listgroup-span">
                    ...
                    <a href="{{ route('service') }}" class="nav-item border-0 list-group-item d-inline-block collapsed text-warning font-weight-bold"><i class="fas fa-table fa-lg img-fluid"></i> <span class="text-left">Service</span></a>
            ...
            <main class="col-md-10 float-left">
                ...
                <table class="table table-hover rounded table-bordered ">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="border-right-0 border-left-0">Send to service</th>
                    </tr>
                    </thead>
                        ...
                        @if( $car->needService)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn btn-lg d-block font-weight-bold btnSubmit" id="bookBtn">Service</button>
                                    {!! Form::close() !!}
                                </td>
                            </tr>
                         @endif
                ...
                <table class="table table-hover rounded table-bordered">
                    <thead class="thead">
                        <tr>
                            ...
                            <th scope="col" class="border-right-0 border-left-0">Status</th>
                            <th scope="col" class="border-right-0 border-left-0">Odometer</th>
                            <th scope="col" class="border-right-0 border-left-0">Return</th>
                        </tr>
                    </thead>
                    <tbody class="font-weight-bold">
                        @foreach($cars as $car)
                            @if($car->status == 2)
                                <tr>
                                    ...
                                    <td>{{$car->odometer}}</td>
                                    <td>
                                        {!! Form::open(['method' => 'POST', 'route' => 'releaseService', ]) !!}
                                        {{ Form::hidden('id', $car->id) }}
                                        <button type="submit" class="btn btn-lg d-block font-weight-bold btnSubmit" id="bookBtn">Release</button>
                                        {!! Form::close() !!}
                                    </td>
                                </tr>
                            @endif
